...
class EnrichedMarkdownText
  ...
  constructor(
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
      // Tables first: the controller never claims the DOWN, so it observes the whole gesture and
      // only takes over once it is a horizontal drag, leaving taps to the checkbox helper.
