...
struct MeasurementCacheKey {
  ...
  bool operator==(const MeasurementCacheKey &other) const
  {
    return std::tie(markdown, maxWidth, allowTrailingMargin, allowFontScaling, maxFontSizeMultiplier,
                    ...
                    md4cFlagsLatexMath, md4cFlagsHardSoftBreaks, md4cFlagsAdmonitions, styleFingerprint, fontScale,
                    flavor, lineBreakStrategyIOS, writingDirection) ==
           std::tie(other.markdown, other.maxWidth, other.allowTrailingMargin, other.allowFontScaling,
                    ...
                    other.md4cFlagsHardSoftBreaks, other.md4cFlagsAdmonitions, other.styleFingerprint, other.fontScale,
                    other.flavor, other.lineBreakStrategyIOS, other.writingDirection);
  }
};
