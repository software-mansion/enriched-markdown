...
// Produced by packages/core/scripts/generate-unicode-tables.mjs
// Node 24.4.1, V8 13.6.233.10-node.17, Unicode 16.0
//
// Inclusive code point ranges matching /[\p{L}\p{N}]/u.
#pragma once

#include <cstddef>
#include <cstdint>

namespace Markdown::UnicodeTables {
...
inline constexpr size_t kLetterOrNumberRangeCount = 770;
inline constexpr Range kLetterOrNumberRanges[kLetterOrNumberRangeCount] = {
    ...
    {0x10D40, 0x10D65}, {0x10D6F, 0x10D85}, {0x10E60, 0x10E7E}, {0x10E80, 0x10EA9},
    ...
    {0x11480, 0x114AF}, {0x114C4, 0x114C5}, {0x114C7, 0x114C7}, {0x114D0, 0x114D9},
    {0x11580, 0x115AE}, {0x115D8, 0x115DB}, {0x11600, 0x1162F}, {0x11644, 0x11644},
    {0x11650, 0x11659}, {0x11680, 0x116AA}, {0x116B8, 0x116B8}, {0x116C0, 0x116C9},
    {0x116D0, 0x116E3}, {0x11700, 0x1171A}, {0x11730, 0x1173B}, {0x11740, 0x11746},
    ...
    {0x11AB0, 0x11AF8}, {0x11BC0, 0x11BE0}, {0x11BF0, 0x11BF9}, {0x11C00, 0x11C08},
    {0x11C0A, 0x11C2E}, {0x11C40, 0x11C40}, {0x11C50, 0x11C6C}, {0x11C72, 0x11C8F},
    ...
    {0x11D98, 0x11D98}, {0x11DA0, 0x11DA9}, {0x11EE0, 0x11EF2}, {0x11F02, 0x11F02},
    ...
    {0x16D70, 0x16D79}, {0x16E40, 0x16E96}, {0x16F00, 0x16F4A}, {0x16F50, 0x16F50},
    ...
    {0x1BC70, 0x1BC7C}, {0x1BC80, 0x1BC88}, {0x1BC90, 0x1BC99}, {0x1CCF0, 0x1CCF9},
    ...
    {0x1E4D0, 0x1E4EB}, {0x1E4F0, 0x1E4F9}, {0x1E5D0, 0x1E5ED}, {0x1E5F0, 0x1E5FA},
